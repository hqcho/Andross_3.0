...
func _physics_process(delta):
	...
	#shooting
	if Input.is_action_pressed("ui_right") and cooldown == 0 or Input.is_action_pressed("ui_left") and cooldown == 0 or Input.is_action_pressed("ui_up") and cooldown == 0 or Input.is_action_pressed("ui_down") and cooldown == 0:
